...
object MostPopularSuperhero {
  ...
  def main(args: Array[String]) {
    ...
    val names = sc.textFile("C:/Users/rodrigo.rondena/Desktop/SparkScala/SparkScalaCourse/marvel-names.txt")
    val namesRdd = names.flatMap(parseNames)
    
    // Load up the superhero co-apperarance data
    val lines = sc.textFile("C:/Users/rodrigo.rondena/Desktop/SparkScala/SparkScalaCourse/marvel-graph.txt")
